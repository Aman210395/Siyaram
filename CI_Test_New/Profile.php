...
class Profile extends CI_Controller{
   ...
   function edit_prof_pic()
   {
    $this->load->view('user/user_pic');
   }

   function update_prof_pic()
   {
      $config['upload_path'] = 'assets/prof_img';
      $config['allowed_types'] = 'bmp|jpg|jpeg|gif|png';
     ...
     if($this->upload->do_upload()==true)
      {
        ...
        $data['prof_img'] = $this->upload->data("file_name");
        $this->load->model("Usermod");
        $this->Usermod->update_by_id($this->session->userdata('uid'),$data);
        // echo $res;die;
        redirect('Profile/profile');
      }
      else{
         ...
         redirect('Profile/edit_prof_pic');
      }
   }
